...
require (
	...
	github.com/pluralsh/bootstrap-operator v0.0.4
...
replace go.etcd.io/etcd/pkg/v3 => go.etcd.io/etcd/pkg/v3 v3.5.0-alpha.0

replace github.com/pluralsh/bootstrap-operator => ../bootstrap-operator
