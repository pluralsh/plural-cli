...
import (
	...
	console "github.com/pluralsh/plural-cli/pkg/console"
...
// CreateBootstrapToken provides a mock function with given fields: attributes
func (_m *ConsoleClient) CreateBootstrapToken(attributes client.BootstrapTokenAttributes) (string, error) {
	...
	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(client.BootstrapTokenAttributes) (string, error)); ok {
		return rf(attributes)
	}
	if rf, ok := ret.Get(0).(func(client.BootstrapTokenAttributes) string); ok {
		r0 = rf(attributes)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(client.BootstrapTokenAttributes) error); ok {
		r1 = rf(attributes)
	} else {
		r1 = ret.Error(1)
	}
...
// CreateClusterRegistration provides a mock function with given fields: attributes
func (_m *ConsoleClient) CreateClusterRegistration(attributes client.ClusterRegistrationCreateAttributes) (*client.ClusterRegistrationFragment, error) {
	ret := _m.Called(attributes)

	if len(ret) == 0 {
		panic("no return value specified for CreateClusterRegistration")
	}

	var r0 *client.ClusterRegistrationFragment
	var r1 error
	if rf, ok := ret.Get(0).(func(client.ClusterRegistrationCreateAttributes) (*client.ClusterRegistrationFragment, error)); ok {
		return rf(attributes)
	}
	if rf, ok := ret.Get(0).(func(client.ClusterRegistrationCreateAttributes) *client.ClusterRegistrationFragment); ok {
		r0 = rf(attributes)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*client.ClusterRegistrationFragment)
		}
	}

	if rf, ok := ret.Get(1).(func(client.ClusterRegistrationCreateAttributes) error); ok {
		r1 = rf(attributes)
	} else {
		r1 = ret.Error(1)
	}
...
// CreateQueuedPrompt provides a mock function with given fields: jobID, prompt, dequeueAt
func (_m *ConsoleClient) CreateQueuedPrompt(jobID string, prompt string, dequeueAt time.Time) (*client.QueuedPromptFragment, error) {
	ret := _m.Called(jobID, prompt, dequeueAt)

	if len(ret) == 0 {
		panic("no return value specified for CreateQueuedPrompt")
	}

	var r0 *client.QueuedPromptFragment
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, time.Time) (*client.QueuedPromptFragment, error)); ok {
		return rf(jobID, prompt, dequeueAt)
	}
	if rf, ok := ret.Get(0).(func(string, string, time.Time) *client.QueuedPromptFragment); ok {
		r0 = rf(jobID, prompt, dequeueAt)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*client.QueuedPromptFragment)
		}
	}

	if rf, ok := ret.Get(1).(func(string, string, time.Time) error); ok {
		r1 = rf(jobID, prompt, dequeueAt)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *ConsoleClient) GetAgentRun(id string) (*client.AgentRunMinimalFragment, error) {
	ret := _m.Called(id)
	...
	var r0 *client.AgentRunMinimalFragment
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (*client.AgentRunMinimalFragment, error)); ok {
		return rf(id)
	}
	if rf, ok := ret.Get(0).(func(string) *client.AgentRunMinimalFragment); ok {
		r0 = rf(id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*client.AgentRunMinimalFragment)
		}
	}
...
// GetGlobalSettingsMinimal provides a mock function with given fields:
...
// GetProvider provides a mock function with given fields: id
func (_m *ConsoleClient) GetProvider(id string) (*client.ClusterProviderFragment, error) {
	ret := _m.Called(id)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (*client.ClusterProviderFragment, error)); ok {
		return rf(id)
	}
	if rf, ok := ret.Get(0).(func(string) *client.ClusterProviderFragment); ok {
		r0 = rf(id)
	} else {
		if ret.Get(0) != nil {
...
// GetWorkbench provides a mock function with given fields: id
func (_m *ConsoleClient) GetWorkbench(id string) (*client.WorkbenchFragment, error) {
	ret := _m.Called(id)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (*client.WorkbenchFragment, error)); ok {
		return rf(id)
	}
	if rf, ok := ret.Get(0).(func(string) *client.WorkbenchFragment); ok {
		r0 = rf(id)
	} else {
		if ret.Get(0) != nil {
...
// IsClusterRegistrationComplete provides a mock function with given fields: machineID
func (_m *ConsoleClient) IsClusterRegistrationComplete(machineID string) (bool, *client.ClusterRegistrationFragment) {
	ret := _m.Called(machineID)

	if len(ret) == 0 {
		panic("no return value specified for IsClusterRegistrationComplete")
	}

	var r0 bool
	var r1 *client.ClusterRegistrationFragment
	if rf, ok := ret.Get(0).(func(string) (bool, *client.ClusterRegistrationFragment)); ok {
		return rf(machineID)
	}
	...
	if rf, ok := ret.Get(1).(func(string) *client.ClusterRegistrationFragment); ok {
		r1 = rf(machineID)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(*client.ClusterRegistrationFragment)
		}
	}
...
func (_m *ConsoleClient) ListAgentRuns(first int64) ([]*client.AgentRunMinimalFragment, error) {
	ret := _m.Called(first)
	...
	var r0 []*client.AgentRunMinimalFragment
	var r1 error
	if rf, ok := ret.Get(0).(func(int64) ([]*client.AgentRunMinimalFragment, error)); ok {
		return rf(first)
	}
	if rf, ok := ret.Get(0).(func(int64) []*client.AgentRunMinimalFragment); ok {
		r0 = rf(first)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*client.AgentRunMinimalFragment)
...
// ListPrAutomations provides a mock function with given fields:
...
// ListStacks provides a mock function with given fields:
func (_m *ConsoleClient) ListStacks() (*client.ListInfrastructureStacks, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func() (*client.ListInfrastructureStacks, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() *client.ListInfrastructureStacks); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*client.ListInfrastructureStacks)
		}
	}
...
// ListWorkbenchJobs provides a mock function with given fields: workbenchID, page, perPage
func (_m *ConsoleClient) ListWorkbenchJobs(workbenchID string, page int, perPage int) ([]console.WorkbenchJob, error) {
	ret := _m.Called(workbenchID, page, perPage)

	if len(ret) == 0 {
		panic("no return value specified for ListWorkbenchJobs")
	}

	var r0 []console.WorkbenchJob
	var r1 error
	if rf, ok := ret.Get(0).(func(string, int, int) ([]console.WorkbenchJob, error)); ok {
		return rf(workbenchID, page, perPage)
	}
	if rf, ok := ret.Get(0).(func(string, int, int) []console.WorkbenchJob); ok {
		r0 = rf(workbenchID, page, perPage)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]console.WorkbenchJob)
		}
	}

	if rf, ok := ret.Get(1).(func(string, int, int) error); ok {
		r1 = rf(workbenchID, page, perPage)
	} else {
		r1 = ret.Error(1)
	}
...
// ListWorkbenches provides a mock function with given fields: after, first, query
func (_m *ConsoleClient) ListWorkbenches(after *string, first *int64, query *string) (*client.ListWorkbenches_Workbenches, error) {
	ret := _m.Called(after, first, query)

	if len(ret) == 0 {
		panic("no return value specified for ListWorkbenches")
	}

	var r0 *client.ListWorkbenches_Workbenches
	var r1 error
	if rf, ok := ret.Get(0).(func(*string, *int64, *string) (*client.ListWorkbenches_Workbenches, error)); ok {
		return rf(after, first, query)
	}
	if rf, ok := ret.Get(0).(func(*string, *int64, *string) *client.ListWorkbenches_Workbenches); ok {
		r0 = rf(after, first, query)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*client.ListWorkbenches_Workbenches)
		}
	}

	if rf, ok := ret.Get(1).(func(*string, *int64, *string) error); ok {
		r1 = rf(after, first, query)
	} else {
		r1 = ret.Error(1)
	}
