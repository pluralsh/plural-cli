...
func Table(c *cli.Context, nextSlide func()) (title string, content tview.Primitive) {
	...
	navigate := func() {
		...
		table.SetDoneFunc(func(key tcell.Key) {
			...
			GetRecipes(row, client, repos, man, table, bundleTable)
	...
	pages.AddPage("main", bundleTable, true, true)
...
func GetRecipes(row int, client *api.Client, repos []*api.Repository, man *manifest.ProjectManifest, table, bundleTable *tview.Table) {
