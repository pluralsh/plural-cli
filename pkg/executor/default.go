...
func defaultClusterAPISteps(path, provider string, manifest *manifest.ProjectManifest) []*Step {
	...
	return []*Step{
		...
		},
		{
			...
			Target:  pluralfile(path, "ONCE"),
			Command: "plural",
			Args:    []string{"wkspace", "helm", sanitizedPath, "--wait", "--skip", "cilium", "--skip", "cluster-api-cluster"},
			Sha:     "",
		},
		{
			Name:    "deploy-cluster",
			...
			Target:  pluralfile(path, "ONCE"),
			Command: "plural",
			Args:    []string{"wkspace", "helm", sanitizedPath, "--skip", "cilium"},
			Sha:     "",
		},
		{
		...
		},
		{
			...
			Target:  pluralfile(path, "ONCE"),
			Command: "plural",
			Args:    []string{"wkspace", "helm", sanitizedPath, "--wait", "--skip", "cluster-api-cluster"},
			Sha:     "",
		},
		{
