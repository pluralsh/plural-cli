...
# v3.24/main contains the pinned package set for both x86_64 and aarch64.
# Keep the existing runtime tools, but pin their complete APK closure so a
# repository update cannot select different packages.
