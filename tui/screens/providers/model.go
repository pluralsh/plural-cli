// Package providers implements the read-only Console cluster providers browser.
package providers
...
// Model owns Providers-screen interaction state.
type Model struct {
	ctx       context.Context
	loader    providersbridge.Loader
	theme     theme.Theme
	mode      mode
	loading   bool
	err       error
...
func New(ctx context.Context, loader providersbridge.Loader, t theme.Theme) Model {
	input := textinput.New()
	input.Prompt = "› "
